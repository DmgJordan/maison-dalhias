          ...
          <div class="max-w-3xl mx-auto">
            <div class="text-center mb-12">
              ...
              <p class="text-lg mb-8 text-text/80">
                Profitez d'un séjour inoubliable dans notre maison située au sein du Domaine du
                Rouret. Bénéficiez de tout le confort d'un logement privé tout en ayant accès aux
                installations et activités du domaine Pierre & Vacances.
              </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div
                v-for="feature in accommodationFeatures"
                :key="feature.title"
            ...
            <div class="text-center">
              <button class="btn-primary" @click="scrollToElement('disponibilites')">
