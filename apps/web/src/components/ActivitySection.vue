...
const galleryImages = ref<GalleryImage[]>([
  {
    id: 1,
    src: 'https://photos.pierreetvacances.com/admin/fp2/photos/panopv/1440x810/AAA_124592_panopv.jpg',
    alt: 'Espace aquatique',
    isMain: true,
  },
  {
    id: 2,
    src: 'https://photos.pierreetvacances.com/admin/fp2/photos/43/500x375/AAA_137135_43.jpg',
    alt: 'Club enfants',
  },
  {
    id: 3,
    src: 'https://photos.pierreetvacances.com/admin/fp2/photos/43/500x375/AAA_137118_43.jpg',
    alt: 'Activités sportives',
  },
  {
    id: 4,
    src: 'https://photos.pierreetvacances.com/admin/fp2/photos/43/800x600/AAA_173718_43.jpg',
    alt: 'Réserve naturelle',
  },
  {
    id: 5,
    src: 'https://photos.pierreetvacances.com/admin/fp2/photos/43/800x600/AAA_164660_43.jpg',
    alt: 'Animations',
  },
]);
...
const mainActivities = [
  {
    ...
    description:
      'Profitez de 2 espaces aquatiques : un espace de 650m² avec rivière sauvage à bouée et un second espace comprenant une piscine extérieure de nage de 350m² et une piscine californienne.',
    icon: 'water',
  },
  {
    title: 'Clubs enfants & ados',
    description:
      "Vos enfants (3-11 ans) et adolescents (12-17 ans) s'amuseront avec des activités encadrées par des animateurs diplômés : chasses au trésor, activités créatives, animations sportives et soirées thématiques.",
    icon: 'users',
  },
  {
    title: 'Animations gratuites',
    description:
      "Profitez d'un programme d'animations variées : blind test, mini-disco, jeux en famille, soirées dansantes et spectacles pour tous les âges.",
    icon: 'music',
  },
  {
    title: 'Equipements sportifs',
    description:
      'De nombreux équipements à votre disposition : terrain multisports, beach-volley, pétanque, tennis de table et séances de fitness, yoga, pilates et aquagym.',
    icon: 'activity',
  },
  {
    title: 'Réserve naturelle',
    description:
      "Découvrez les magnifiques paysages de l'Ardèche : Gorges de l'Ardèche, grotte Chauvet et parc naturel des Monts d'Ardèche à proximité immédiate.",
    icon: 'tree',
  },
];
...
<template>
  <section id="activites" class="py-16 bg-gray-50">
    <div class="container-custom">
      ...
      <p class="text-center text-text/80 mb-8">
        Découvrez toutes les activités disponibles au Domaine du Rouret
      </p>
